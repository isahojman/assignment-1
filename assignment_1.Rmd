...
a. Il y a deux types de calcule dans cette data : d'une part, on compte la fréquence de 198 verbs de chaque groupe dans un corpus; d'une autre part, on compte combien de verbes ont une fréquence de 0, 1, etc. pour remplir l'histogramme. 

b. Cette question n'est pas répondu par les histogrammes car on travaille sur des samples qui peuvent représenter ou pas la poblation de laquelle elles sont extraites. 

Si l'hypothèse A était vraie, cela voudrait dire que les verbes opaques et transparent ne présentent pas de différences à niveau de leur fréquence : avec une sample suffisament représentative de chaque groupe on trouveras des patrons très similaires, ce qui n'est pas le cas pour les histogrammes qu'on a, soit parce que l'hypopthèse est fausse, soit parce que les samples ne sont pas suffisament représentatifs.
